...
private[spark] case class HostGained(hostPort: String) extends DAGSchedulerEvent

private[spark] case class HostLost(hostPort: String) extends DAGSchedulerEvent
